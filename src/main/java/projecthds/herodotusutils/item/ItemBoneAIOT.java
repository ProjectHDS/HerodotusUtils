...
public class ItemBoneAIOT extends ItemHoeBase {
    public static final int MAX_DAMAGE = ModuleToolConfig.DURABILITY.get("bone_durable");
    public ItemBoneAIOT(ToolMaterial material, String toolTierName) {
        super(EnumMaterial.BONE.getToolMaterial(), "bone_durable");
        this.setHarvestLevel("pickaxe", 3);
        this.setHarvestLevel("axe", 3);
        this.setHarvestLevel("shovel", 3);
        this.setRegistryName("bone_aiot");
        this.setUnlocalizedName(HerodotusUtils.MOD_ID + ".bone_aiot");
        this.setFull3D();
    }

    public static final ItemBoneAIOT INSTANCE = new ItemBoneAIOT(EnumMaterial.BONE.getToolMaterial(), "bone_durable");
